...
- [Java 25](https://jdk.java.net/25/) - **The JVM must be installed**

## Instructions

1. Download the latest `.jar` files from the [Releases](https://github.com/ghost-in-a-jar-00/lockfs/releases) page
